def echo():
    ...
    car = car.replace("ch", "ች") # check priority
    car = car.replace("H", "ሕ") # check priority
    car = car.replace("sh", "ሽ") # check priority
    car = car.replace("Q", "ቕ") # check priority
    car = car.replace("Ch", "ጭ")  #====== check priority
    car = car.replace("ts", "ፅ") # ckeck priority
    car = car.replace("A", "ዓ") #
